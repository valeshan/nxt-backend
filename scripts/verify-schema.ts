...
const CRITICAL_CHECKS: ColumnCheck[] = [
  ...
  },
  {
    ...
    expectedColumns: [
      ...
      'organisationId',
      'locationId',
      'hasSeenRetroAutoApproveDiscovery',
      'retroAutoApproveDiscoverySeenAt',
      'createdAt',
    ],
    description: 'User-location scoped access control',
  },
  {
    tableName: 'CanonicalInvoice',
    expectedColumns: ['id', 'organisationId', 'locationId', 'warningLineCount'],
    description: 'CanonicalInvoice header-level quality fields (banner-safe queries)',
  },
  {
    tableName: 'RetroAutoApproveBatch',
    expectedColumns: [
      'id',
      'organisationId',
      'locationId',
    ...
    description: 'Retro auto-approve idempotency + batch summary table',
  },
  {
    tableName: 'InvoiceAuditEvent',
    expectedColumns: [
      'id',
      'organisationId',
      'locationId',
    ...
    description: 'Per-invoice audit events for batch auto-approval',
  },
];
